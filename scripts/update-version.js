...
try {
  ...
  const gitCommit = `git config user.email kraneabel@gmail.com && git config user.name "Ayinla Abel" && git commit -am "[skip ci] update build number to: ${currentVersion.build}" && sleep 2 && git push`;
