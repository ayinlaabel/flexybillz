...
try {
  ...
  const gitCommit = `git remote set-url origin https://ayinlaabel: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@github.com/ayinlaabel/flexybillz.git && git config user.email kraneabel@gmail.com && git config user.name "Ayinla Abel" && git commit -am "[skip ci] update build number to: ${currentVersion.build}" && sleep 2 && git push`;
